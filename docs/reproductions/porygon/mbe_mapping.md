...
| Execution Sub-Committee | logical `execution_shard_count` lanes inside `porygon_block_executor` |
...
| Single-Shard Execution | one business execution attempt on one ESC |
