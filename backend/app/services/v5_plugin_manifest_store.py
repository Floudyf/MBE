...
_MANIFESTS = [
    ...
    _manifest(
        ...
        "Executes MetaTrack fast/conservative ready queues with dependency release callbacks over MBE transfer semantics.",
        config={"worker_count": 1},
        schema=_schema({"worker_count": {"type": "integer", "minimum": 1, "maximum": 4, "default": 1}}),
        capabilities=["metatrack_ready_queues", "dependency_release", "deterministic_state_delta", "execution_plan_digest"],
        ...
        supported_backends=["real_cluster"],
        truth_boundary="metatrack_control_plane_executor_over_mbe_transfer_semantics",
    ),
    _manifest(
        ...
        config={"worker_count": 4, "maximum_incarnations": 16},
        schema=_schema({
            "worker_count": {"type": "integer", "minimum": 1, "maximum": 8, "default": 4},
            "maximum_incarnations": {"type": "integer", "minimum": 1, "maximum": 64, "default": 16},
        }),
        ...
        supported_backends=["real_cluster"],
        truth_boundary="staged_block_stm_prototype",
