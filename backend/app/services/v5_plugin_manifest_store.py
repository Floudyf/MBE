...
_MANIFESTS = [
    ...
    _manifest(
        ...
        "Deterministic fast/conservative admission driven by access stability, dependency-topology safety, and execution-semantic stability. Access-list size is diagnostic only and does not choose the track.",
        aliases=["dual_track"],
        capabilities=["dual_track", "access_stability_admission", "known_direction_topology_safe_fast_admission", "semantic_stability_admission", "state_ready_orthogonal_to_track", "nontrivial_scc_conservative_fallback"],
        truth_boundary="metatrack_dual_track_execution_stability_v1",
    ),
