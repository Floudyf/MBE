...
CATALOG: dict[str, V3ModuleCapability] = {
    ...
    "Consensus": module(
        ...
        plugins=[
            ...
            runnable("blockemulator_aligned_pbft_preview", "BlockEmulator-aligned PBFT state machine preview"),
...
SINGLE_MODULE_TEMPLATE_CATALOG: dict[str, dict[str, Any]] = {
    ...
    "single_module_consensus": {
        ...
        "truthfulness_note": "pbft_light_model is PBFT-style stage/quorum/message-count model only. blockemulator_aligned_pbft_preview is a deterministic PBFT state machine preview only. Neither is production PBFT or full PBFT over TCP.",
        "default_preset_id": "consensus_light_smoke",
        "presets": [
            {
                "preset_id": "consensus_light_smoke",
                "preset_name": "Consensus-light smoke",
                "description": "Runs a local Draft Smoke that focuses on simple_leader, PoA-light, PBFT-light, or optional PBFT state machine preview metrics.",
                "default_chain_profile": "single_chain_research_default",
                "default_plugin_selection": dict(SINGLE_MODULE_LOCKED_PLUGIN_VALUES),
                "variable_module": "Consensus",
                ...
                "expected_artifacts": ["consensus_log.csv", "pbft_state_log.csv", "pbft_message_log.csv", "quorum_log.csv", "finalized_block_log.csv", "block_log.csv", "summary.csv", "summary.json", "tx_results.csv"],
                "result_guide": "Focus on consensus runtime selection, consensus latency, message count, PBFT preview stage/quorum artifacts when selected, and consensus_log.csv.",
                "truthfulness_note": "blockemulator_aligned_pbft_preview is a deterministic state machine preview. It is not production PBFT, not full PBFT over TCP, and not full Byzantine safety.",
            }
        ],
    },
