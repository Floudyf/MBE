        ...
        "profiles": [
            {
                ...
                "min_stage": "V3.6.2",
                "runnable": True,
                "description": "Single Composer Draft Smoke plugin selection with consensus-light over NetworkAdapter typed message preview artifacts.",
                "plugins": plugins,
