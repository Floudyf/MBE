        ...
        "profiles": [
            {
                ...
                "min_stage": "V3.7.2",
                "runnable": True,
                "description": "Single Composer Draft Smoke plugin selection with optional ConsensusRuntime PBFT preview over NetworkAdapter artifacts.",
                "plugins": plugins,
