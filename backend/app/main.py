...
V3_CURRENT_STAGE = "V3.8 CrossShardProtocol Skeleton Closure"
V3_LATEST_RUNTIME_STAGE = "configurable CrossShardProtocol skeleton with relay_preview artifacts"
