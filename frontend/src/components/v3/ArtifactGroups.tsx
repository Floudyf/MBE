...
const groups = [
  { title: "Run Summary", files: ["summary.csv", "summary.json", "report.md", "metatrack_summary.csv", "metatrack_summary.json", "metatrack_ablation_report.md"] },
  { title: "Chain Logs", files: ["block_log.csv", "tx_results.csv", "state_commit_log.csv"] },
