...
const groups = [
  { title: "正式性能实验核心结果", defaultOpen: true, files: ["formal_benchmark_config.json", "formal_matrix_preview.json", "formal_run_matrix.csv", "formal_run_index.csv", "formal_raw_summary.csv", "formal_aggregate_summary.csv", "summary.json"] },
