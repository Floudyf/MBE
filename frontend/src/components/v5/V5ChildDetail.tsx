...
function mechanismRows(metrics: Record<string, unknown>): Row[] { return [["worker_count", metrics.worker_count], ["maximum_parallel_width", metrics.maximum_parallel_width], ["abort_count", metrics.abort_count], ["reexecution_count", metrics.reexecution_count], ["dependency_wait_count", metrics.dependency_wait_count], ["validation_failure_count", metrics.validation_failure_count], ["scheduler_event_count", metrics.scheduler_event_count], ["scheduler_blocked_count", metrics.scheduler_blocked_count], ["scheduler_wakeup_count", metrics.scheduler_wakeup_count], ["scheduler_stolen_work_count", metrics.scheduler_stolen_work_count], ["scheduler_fast_queue_event_count", metrics.scheduler_fast_queue_event_count], ["scheduler_conservative_queue_event_count", metrics.scheduler_conservative_queue_event_count], ["scheduler_ready_queue_max_depth", metrics.scheduler_ready_queue_max_depth], ["scheduler_fast_queue_max_depth", metrics.scheduler_fast_queue_max_depth], ["scheduler_conservative_queue_max_depth", metrics.scheduler_conservative_queue_max_depth], ["scheduler_dependency_wait_ms", metrics.scheduler_dependency_wait_ms], ["scheduler_idle_ms", metrics.scheduler_idle_ms], ["scheduler_idle_ratio", metrics.scheduler_idle_ratio], ["remote_state_access_count", metrics.remote_state_access_count], ["remote_state_read_count", metrics.remote_state_read_count], ["remote_state_write_apply_count", metrics.remote_state_write_apply_count], ["remote_state_access_avg_latency_ms", metrics.remote_state_access_avg_latency_ms], ["aggregation_group_count", metrics.aggregation_group_count], ["logical_update_count", metrics.logical_update_count], ["physical_update_count", metrics.physical_update_count], ["serial_equivalent", metrics.serial_equivalent]]; }
