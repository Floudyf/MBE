...
export type V5FormalMethod = { method_id: string; display_name: string; plugin_overrides: Record<string, string>; plugin_config_overrides?: Record<string, Record<string, unknown>>; role?: "main" | "baseline" | "ablation" | "compatibility" | "custom" };
...
export type V5ArtifactStorageChild = {
  ...
  ntfs_compression_succeeded?: boolean | null; ntfs_compression_error?: string; archive_format?: string | null; archive_layout?: string | null; archive_dedup_schema?: string | null; archive_unique_object_count?: number | null; archive_duplicate_logical_bytes?: number | null; archive_bytes?: number | null; archive_sha256?: string | null; archive_verified?: boolean | null; archived_file_count?: number | null; raw_deleted_after_verification?: boolean | null; archive_download_url?: string | null; formal_eligibility_affected?: boolean;
};
...
export async function archiveV5ArtifactStorage(groupId: string, deleteRaw = true, compressionLevel = 10): Promise<V5ArtifactStorageGroup> {
