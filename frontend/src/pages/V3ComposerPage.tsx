...
const currentStageLabel = "V3.10 Benchmark / Experiment Template Hardening Closure";
const latestRuntimeLabel = "benchmark template catalog, baseline profile catalog, local sweep runner, reproducibility manifest, and benchmark report artifacts";
const runtimeBoundaryText = "V3.10 closes benchmark / experiment template hardening by adding benchmark template catalog, baseline profile catalog, local sweep runner, multi-seed repeatability, reproducibility manifest, and benchmark report artifacts. It is not paper-grade benchmark evidence, not a large-scale distributed benchmark, not a production network, not BlockEmulator backend, and not a performance superiority claim. V3.11 has not started here.";
const templateStageNote = "Template stage note: metatrack_ablation was introduced in V3.4.9; the controlled runner was introduced in V3.4.10; V3.5 added topology, launcher, and node process preview; V3.6 added NetworkAdapter and consensus-light over typed messages; V3.7 closed optional PBFT preview over NetworkAdapter; V3.8 closed CrossShardProtocol skeleton; V3.9 closed State Authenticity MVP; V3.10 closes benchmark template hardening.";
