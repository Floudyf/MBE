...
const currentStageLabel = "V3.7.2 V3.7 Closure";
const latestRuntimeLabel = "configurable ConsensusRuntime with PBFT preview over NetworkAdapter";
const runtimeBoundaryText = "V3.7.2 closes V3.7 by running optional blockemulator_aligned_pbft_preview over the selected NetworkAdapter typed message path. It is not production PBFT, not full Byzantine safety, not view-change/checkpoint/signature hardening, not HotStuff/Raft, not Fabric/EVM live, not BlockEmulator backend, not a real cross-shard protocol, and not a paper-grade benchmark. V3.8 has not started here.";
