...
const currentStageLabel = "V3.6.1 NetworkAdapter";
const latestRuntimeLabel = "localhost TCP typed message preview";
const runtimeBoundaryText = "V3.6.1 adds configurable NetworkAdapter support with in-memory compatibility and localhost TCP typed message preview. It is not real PBFT/HotStuff/Raft, not production networking, not Fabric/EVM live, not BlockEmulator backend, not a real cross-shard protocol, and not a paper-grade benchmark.";
