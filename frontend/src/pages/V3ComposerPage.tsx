...
const currentStageLabel = "V3.7.1";
const latestRuntimeLabel = "configurable ConsensusRuntime with PBFT state machine preview";
const runtimeBoundaryText = "V3.7.1 adds optional blockemulator_aligned_pbft_preview as a deterministic PBFT state machine preview. It is not production PBFT, not full PBFT over TCP, not view-change/checkpoint/signature hardening, not HotStuff/Raft, not Fabric/EVM live, not BlockEmulator backend, not a real cross-shard protocol, and not a paper-grade benchmark. V3.7.2 has not started here.";
const templateStageNote = "Template stage note: metatrack_ablation was introduced in V3.4.9; the controlled runner was introduced in V3.4.10; V3.5 added topology, launcher, and node process preview; V3.6 added NetworkAdapter and consensus-light over typed messages; V3.7.1 adds configurable ConsensusRuntime with optional PBFT state machine preview.";
