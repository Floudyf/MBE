...
const currentStageLabel = "V3.8 CrossShardProtocol Skeleton Closure";
const latestRuntimeLabel = "configurable CrossShardProtocol skeleton with relay_preview artifacts";
const runtimeBoundaryText = "V3.8 closes CrossShardProtocol skeleton work by detecting cross-shard transactions and writing relay_preview artifacts under Routing/Sharding. It is not complete Relay, not Broker, not 2PC, not atomic cross-shard commit, not cross-shard proof, not Fabric/EVM live, not BlockEmulator backend, and not a paper-grade benchmark. V3.9 has not started here.";
const templateStageNote = "Template stage note: metatrack_ablation was introduced in V3.4.9; the controlled runner was introduced in V3.4.10; V3.5 added topology, launcher, and node process preview; V3.6 added NetworkAdapter and consensus-light over typed messages; V3.7 is now closed with optional PBFT preview over NetworkAdapter.";
