...
const currentStageLabel = "V3.6.2 V3.6 Closure";
const latestRuntimeLabel = "consensus-light over NetworkAdapter typed messages";
const runtimeBoundaryText = "V3.6.2 closes V3.6 with configurable NetworkAdapter support and consensus-light proposal/vote preview over typed messages. It is not real PBFT/HotStuff/Raft, not production networking, not Fabric/EVM live, not BlockEmulator backend, not a real cross-shard protocol, and not a paper-grade benchmark. V3.7 has not started here.";
const templateStageNote = "Template stage note: metatrack_ablation was introduced in V3.4.9; the controlled runner was introduced in V3.4.10; logical node topology was introduced in V3.5.1; launcher preview artifacts in V3.5.2; node process preview entry point and V3.5 closure in V3.5.3/V3.5.4; NetworkAdapter typed message preview starts in V3.6.1; consensus-light over NetworkAdapter closes V3.6 in V3.6.2.";
