...
const currentStageLabel = "V3.5.4 Closure";
const latestRuntimeLabel = "V3.5 Local Node Process Preview";
const runtimeBoundaryText = "V3.5 is closed with configurable logical node topology, launcher preview artifacts, and a local node process preview entry point. It remains preview-only: not real TCP, not a real multi-process network runtime, not real PBFT/HotStuff/Raft, not Fabric/EVM live, not BlockEmulator backend, not a real cross-shard protocol, and not a paper-grade benchmark.";
const templateStageNote = "Template stage note: metatrack_ablation was introduced in V3.4.9; the controlled runner was introduced in V3.4.10; logical node topology was introduced in V3.5.1; launcher preview artifacts in V3.5.2; node process preview entry point and V3.5 closure in V3.5.3/V3.5.4.";
