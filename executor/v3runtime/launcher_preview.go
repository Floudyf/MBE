...
func windowsLauncherScript(launcher LauncherPreview) string {
	lines := []string{
		"@echo off",
		"REM V3.6.2 local node process and NetworkAdapter consensus-light preview only. Not real PBFT.",
...
func linuxLauncherScript(launcher LauncherPreview) string {
	lines := []string{
		"#!/usr/bin/env bash",
		"set -euo pipefail",
		"# V3.6.2 local node process and NetworkAdapter consensus-light preview only. Not real PBFT.",
