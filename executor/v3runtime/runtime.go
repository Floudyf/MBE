...
type ExperimentProfile struct {
	...
	RelayFailureMode             string
	RelayForceProofFailEveryN    int
	RelayForceTimeoutEveryN      int
	RelayTimeoutMS               int
	StateBackend                 string
...
type Summary struct {
	...
	RelayMVPEnabled                  bool    `json:"relay_mvp_enabled"`
	RelayMVPTxCount                  int     `json:"relay_mvp_tx_count"`
	RelaySourceLockCount             int     `json:"relay_source_lock_count"`
	RelayCertificateCount            int     `json:"relay_certificate_count"`
	RelayProofVerifiedCount          int     `json:"relay_proof_verified_count"`
	RelayProofFailedCount            int     `json:"relay_proof_failed_count"`
	RelayTargetVerifiedCount         int     `json:"relay_target_verified_count"`
	RelayTargetCommitCount           int     `json:"relay_target_commit_count"`
	RelaySourceFinalizedCount        int     `json:"relay_source_finalized_count"`
	RelayTimeoutCount                int     `json:"relay_timeout_count"`
	RelayRefundCount                 int     `json:"relay_refund_count"`
	RelayAbortCount                  int     `json:"relay_abort_count"`
	RelaySuccessCount                int     `json:"relay_success_count"`
	RelayFailedCount                 int     `json:"relay_failed_count"`
	RelayAvgLatencyMS                float64 `json:"relay_avg_latency_ms"`
	RelayMVPTruth                    string  `json:"relay_mvp_truth"`
...
func parseChainProfile(text string) ChainProfile {
	...
	return ChainProfile{
		...
		StateBackend:           NormalizeStateBackend(sectionFieldString(text, "state", "backend", fieldString(text, "state_backend", StateBackendMemoryKV))),
...
func parseExperimentProfile(text string) ExperimentProfile {
	return ExperimentProfile{
		...
		RelayFailureMode:             fieldString(text, "relay_failure_mode", sectionFieldString(text, "cross_shard", "relay_failure_mode", "none")),
		RelayForceProofFailEveryN:    fieldInt(text, "relay_force_proof_fail_every_n", sectionFieldInt(text, "cross_shard", "relay_force_proof_fail_every_n", 0)),
		RelayForceTimeoutEveryN:      fieldInt(text, "relay_force_timeout_every_n", sectionFieldInt(text, "cross_shard", "relay_force_timeout_every_n", 0)),
		RelayTimeoutMS:               fieldInt(text, "relay_timeout_ms", sectionFieldInt(text, "cross_shard", "relay_timeout_ms", 0)),
...
func applyCrossShardProtocolMetrics(summary *Summary, preview CrossShardProtocolPreview) {
	...
	summary.RelayMVPEnabled = preview.RelayMVP.Enabled
	summary.RelayMVPTxCount = preview.RelayMVP.TxCount
	summary.RelaySourceLockCount = preview.RelayMVP.SourceLockCount
	summary.RelayCertificateCount = preview.RelayMVP.CertificateCount
	summary.RelayProofVerifiedCount = preview.RelayMVP.ProofVerifiedCount
	summary.RelayProofFailedCount = preview.RelayMVP.ProofFailedCount
	summary.RelayTargetVerifiedCount = preview.RelayMVP.TargetVerifiedCount
	summary.RelayTargetCommitCount = preview.RelayMVP.TargetCommitCount
	summary.RelaySourceFinalizedCount = preview.RelayMVP.SourceFinalizedCount
	summary.RelayTimeoutCount = preview.RelayMVP.TimeoutCount
	summary.RelayRefundCount = preview.RelayMVP.RefundCount
	summary.RelayAbortCount = preview.RelayMVP.AbortCount
	summary.RelaySuccessCount = preview.RelayMVP.SuccessCount
	summary.RelayFailedCount = preview.RelayMVP.FailedCount
	summary.RelayAvgLatencyMS = preview.RelayMVP.AvgLatencyMS
