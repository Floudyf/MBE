...
func (p batchSIBlockExecutor) ExecuteBlock(ctx context.Context, input BlockExecutionInput) (BlockExecutionResult, error) {
	...
	actual := map[string]any{
		...
		"graph_table_construction_ms":              consensusPlan.Metrics.TableConstructionMS,
		"sorting_ms":                               consensusPlan.Metrics.SortingMS,
		"batch_si_table_construction_ms":           consensusPlan.Metrics.TableConstructionMS,
		"batch_si_sorting_ms":                      consensusPlan.Metrics.SortingMS,
