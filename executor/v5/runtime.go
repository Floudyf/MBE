...
func (r *NodeRuntime) requestCatchup(ctx context.Context) {
	...
	request := CatchupRequest{ShardID: r.node.ShardID, FromHeight: from, ToHeight: from + 8, KnownHeight: knownHeight, KnownHash: knownHash}
